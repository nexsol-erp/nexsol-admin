...
const BranchStockDiffReport = () => {
    ...
    // endpoint you want to hit (adjust path as needed)
    const POST_ENDPOINT = (tenancyId) => `/api/${tenancyId}/inventory/reconcile-item`;
    // e.g. could be /api/{company}/inventory/reconcile-item
    ...
    const postForItem = async (itemId) => {
        ...
        try {
            ...
            // Optional: read response data
            // const data = await res.json();

            // Refresh table after success
            await fetchDiff(); // or fetchStock() in your other component
        } catch (e) {
